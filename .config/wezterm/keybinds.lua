...
return {
  keys = {
    ...
    { key = 'h', mods = 'SUPER|SHIFT', action = act.AdjustPaneSize { 'Left', 5 } },
    { key = 'j', mods = 'SUPER|SHIFT', action = act.AdjustPaneSize { 'Down', 5 } },
    { key = 'k', mods = 'SUPER|SHIFT', action = act.AdjustPaneSize { 'Up', 5 } },
    { key = 'l', mods = 'SUPER|SHIFT', action = act.AdjustPaneSize { 'Right', 5 } },
    { key = 'm', mods = 'SHIFT|CTRL', action = act.Hide },
